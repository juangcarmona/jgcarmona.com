...
El equipo pasó de ser sólo yo, desarrollando pruebas de concepto, experimentos, librerías de utilidades e infrastructura, a ser un equipo multidisciplinar con cuatro desarrolladores .NET, los cuatro full stack pero cada uno de nosotros destacando en otros ámbitos, un arqutiecto Big Data, un científico de datos, dos testers y un Project Manager... Y en pocos meses pudimos poner en producción un producto que sé que tras mi marcha de aquel proyecto sigue creciendo y cada vez atrayendo más y más miradas. Si estás leyendo esto comprenderás que no puedo dar detalles de ese proyecto, no más detalles que los que la propia empresa ha hecho públicos, así que te invito a echarle a leer y ver lo que [Alstom ha publicado sobre Mastria](http://www.alstom.com/products-services/product-catalogue/rail-systems/signalling/products/mastria-multimodal-solution/), el proyecto del que más orgulloso me siento hasta la fecha.
...
El caso es que de todo esto que ahora forma parte de mis conocimientos poco he podido compartir con el mundo.Si, he escrito algunos artículos en [Code Project](https://www.codeproject.com/script/Membership/View.aspx?mid=11268897) y en [Medium](https://medium.com/@d.jgc.it) y he contestado muchas preguntas en [Stack Overflow](https://stackoverflow.com/users/3699830/juan?tab=profile) pero saben a poco en comparación con lo que yo creo que podría haber aportado durante todo este tiempo.  
