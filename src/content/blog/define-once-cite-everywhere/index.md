...
Be honest about who reads these files. Humans read them once, while defining the goals, and then move on to the code. From that point on, specs are words that only a coding agent reads, on every invocation, as truth. Which means a fork like the one above doesn't get caught in review. It gets **implemented**.
...
The rule changes through review, through your normal flow, and 30 days becomes 14. You don't grep the repo wondering which documents still say the old thing:
...
- **Forks become impossible.** There is nothing to fork because the rule has one home.
...
Run it on your own specs. Pick your most-repeated business rule and count the wordings. If you find a fork, I want to hear about it. And if you want citations running on your repo, I'll help you set it up. It takes about ten minutes, maybe less: [reach out on LinkedIn](https://www.linkedin.com/in/juangcarmona).
