...
The Dutch VAT return existed twice in the code. Two schemas, two field sets (they shared exactly one field), two different lifecycles. The result was real: the wrong schema got picked at runtime, integrations failed, and there was a security hole where a stranger could create a tax filing inside someone else's books.
...
> shillinq adds no per-app controller for BTW filing
...
I verified all of this myself, line by line, in the public repo. Not in old history — in the current spec folder. It is not a story. It happened.
